...
def get_args():
    ...
    p.add_argument("--log-file", type=str, default="best.csv")
    p.add_argument("--model-save", type=str, default="best1.torch")
    p.add_argument("--predictions-file", type=str, default="best-predictions.txt")
    ...
    p.add_argument('--cnn-n2-kernel', type=int, default=9)
